...
$media_page_url = new \moodle_url('/local/parrot_social/pages/parrot_media.php', array('parrot_id' => $parrot_id));
...
echo $OUTPUT->render_from_template('local_parrot_social/parrot_profile', array(
