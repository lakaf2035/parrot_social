 ...
 * @author    German Kafo : Laahtech
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */


$string['pluginname'] = 'Parrot Social';
$string['parrot_social:addinstance'] = 'parrot_social Block hinzufügen';
$string['parrot_social:manage'] = 'parrot_social Manage Capability';
$string['parrot_social:myaddinstance'] = 'parrot_social Block hinzufügen';
...
$string['parrot_social:canforward2ndlevel'] = 'Kann Probleme an das Plattform Support Team melden';
...
$string['cron:reminder:title'] = 'parrot_social Erinnerung';
$string['cron:reminder:intro'] = 'Dies ist eine freundlicher Erinnerung an jene offenen Tickets, die Ihnen als parrot_socialer zugeteilt wurden!';
...
$string['parrot_social:manage'] = 'Verwalten';
...
$string['supportforum:choose'] = 'Foren für parrot_social auswählen';
...
/* Privacy API */
$string['privacy:metadata:parrot_social:subscr'] = 'Alle beobachteten Tickets';
$string['privacy:metadata:parrot_social:issues'] = 'Tickets des Supporters';
$string['privacy:metadata:parrot_social:fieldid'] = 'Id';
$string['privacy:metadata:parrot_social:issueid'] = 'Ticket Id';
$string['privacy:metadata:parrot_social:discussionid'] = 'Forum Diskussions Id ';
$string['privacy:metadata:parrot_social:userid'] = 'User Id';
$string['privacy:metadata:parrot_social:supporters'] = 'Alle Supporter';
$string['privacy:metadata:parrot_social:supportlvl'] = 'Supportlevel';
$string['privacy:metadata:parrot_social:courseid'] = 'Kurs Id mit dem Supportforum';
$string['privacy:metadata:parrot_social:currentsupporter'] = 'User Id des supportenden Users';
$string['privacy:metadata:parrot_social:opened'] = 'Ticketstatus';

$string['media'] = 'Medien';
$string['edit_media'] = 'Medien bearbeiten';
$string['cancel_edit_media'] = 'Medienbearbeitung abbrechen';
$string['friends'] = 'Freunde';
$string['confirm_post_delete'] = 'Löschen des Beitrags bestätigen';
$string['confirm_post_delete_message'] = 'Diese Aktion kann nicht rückgängig gemacht werden. Möchten Sie diesen Beitrag wirklich löschen?';
$string['confirm_post_delete_cancel'] = 'Abbrechen';
$string['confirm_post_delete_yes'] = 'Ja, löschen';
$string['share_post'] = 'Beitrag teilen';
$string['edit_post'] = 'Beitrag bearbeiten';
$string['edit_post_cancel'] = 'Beitragsbearbeitung abbrechen';
$string['edit_post_delete'] = 'Beitrag löschen';
$string['friendship_requests'] = 'Freundschaftsanfragen';
$string['requests_received'] = 'Erhaltene Anfragen';
$string['no_invitations'] = 'Keine Einladungen';
$string['new_post'] = 'Neuer Beitrag';
$string['edit_parrot'] = 'Papageieninfo bearbeiten';
$string['edit_parrot_cancel'] = 'Bearbeitung abbrechen';
$string['send_friendship_requests'] = 'Freundschaftsanfrage senden';
$string['posts'] = 'Beiträge';
$string['no_post'] = 'Keine Beiträge';
$string['invitation_accept'] = 'Akzeptieren';
$string['invitation_reject'] = 'Ablehnen';

$string['messageprovider:friendrequestresponded'] = 'Benachrichtigung über Antwort auf Freundschaftsanfrage';
$string['messageprovider:friendrequest'] = 'Benachrichtigung über Freundschaftsanfragen';
$string['sent_friendship_request'] = 'hat dir eine Freundschaftsanfrage geschickt';
$string['accepted_friendship_request'] = 'habe deine Freundschaftsanfrage angenommen';
$string['rejected_friendship_request'] = 'Ihre Freundschaftsanfrage wurde abgelehnt';
$string['check_it_out'] = 'Überprüfen Sie es';
$string['owner'] = 'Eigentümer';
$string['cancel_friendship'] = 'Freundschaft auflösen';

//added
$string['post_title'] = 'Titel';
$string['post_text'] = "Inhalt";
$string['parrot_profile_picture'] = "Papageien-Profilfoto";
$string['parrot_title'] = 'Name';
$string['name_required'] = "Papageienname ist obligatorisch";
$string['parrot_description'] = 'Beschreibung';
$string['update'] = 'Aktualisieren';

$string['category_heading'] = "Papageien";
$string['profile_heading'] = 'Meine Papageien';
$string['parrot_profile_title'] = "Papageienprofil";
$string['create_post'] = 'Beitrag erstellen';
$string['title_required'] = "Post erfordert einen Titel";

$string['click_to_see_more'] = 'mehr sehen';
$string['click_to_see_less'] = 'weniger sehen';
$string['parrot_media_title'] = 'Papageien-Medien';
